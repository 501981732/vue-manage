...
sliderAnimate.prototype = {
	...
	create: function(t, i, e) {
		...
		for (var o = this.cutX * this.cutY, r = Math.ceil(n / this.cutX), d = Math.ceil(a / this.cutY), c = "", h = 0; o > h; h++) {
...
var tools = {
	...
	chromeSupport: function() {
		...
		$("body").append('<div class="chrome-1491013521193"><div><a href="http://rj.baidu.com/soft/detail/14744.html?ald"><img src="../images/chrome.svg" alt="chrome"></a><h3><i class="iconfont"></i>当前浏览器不支持浏览，请更换谷歌浏览器</h3></div></div>')
	},
	loading: function() {
		$("body").append('<div class="ajax_loading"><div><a href="#"><img src="../images/loading_ajax.gif" alt="chrome"></a><h3>加载中....</h3></div></div>')
	}
};